...
export declare class BookingsService {
    ...
    constructor(bookingsRepository: Repository<Booking>, usersService: UsersService, paymentsService: PaymentsService, smsService: SmsService, vehiclesService: VehiclesService, driversService: DriversService);
