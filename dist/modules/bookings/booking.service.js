...
let BookingsService = class BookingsService {
    ...
    constructor(bookingsRepository, usersService, paymentsService, smsService, vehiclesService, driversService) {
    ...
    async assignDriver(bookingId, driverId) {
        ...
        if (!driver || !driver.vehicle)
            throw new common_1.BadRequestException('Driver or vehicle not found');
        ...
        if (vehicle.seatsAvailable < booking.seatsBooked) {
            throw new common_1.BadRequestException('Not enough seats available in the vehicle');
        }
        ...
        if (newSeatsAvailable === 0) {
            await this.driversService.updateStatus(driverId, enums_1.DriverStatus.BUSY);
        }
        const updatedBooking = await this.updateStatus(bookingId, enums_1.BookingStatus.ASSIGNED, { driverId });
