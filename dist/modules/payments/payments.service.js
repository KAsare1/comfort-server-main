...
let PaymentsService = class PaymentsService {
    ...
    async initializePayment(initializeDto) {
        ...
        const paystackResponse = await this.paystackService.initializePayment(initializeDto.customerEmail || booking.customer.email || `${booking.customer.phone}@comfort.com`, initializeDto.amount, reference, initializeDto.callbackUrl, {
